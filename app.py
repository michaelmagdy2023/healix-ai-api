...
def predict():
    try:
        ...
        age = data.get('age', 30)
        sex_enc = data.get('sex_enc', 1) # 1 for Male, 0 for Female
        ...
        # 2. حساب المؤشرات الخطرة (Feature Engineering) بناءً على كود زميلك
        ...
        # 3. ترتيب الـ 27 متغير زي ما الموديل متدرب عليهم بالظبط
        features = np.array([[
            ...
            hr, 0, 0, temp, 0, 0, spo2, 0, 0, # قيم تقريبية للوقت الحالي
        ...
        # 0 = Normal/Stable, 1 = Abnormal/Danger
